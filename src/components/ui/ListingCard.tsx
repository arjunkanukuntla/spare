...
import { Clock, MapPin, ArrowUpRight, ShieldCheck } from 'lucide-react';
...
export const ListingCard: React.FC<ListingCardProps> = ({ listing, onSelect, onClaimQuick }) => {
  ...
  return (
    <div 
      className="bg-white rounded-2xl border border-slate-200/90 shadow-spare-card hover:shadow-md transition-all duration-200 overflow-hidden flex flex-col justify-between group cursor-pointer"
    ...
    >
      ...
      <div className="relative aspect-[4/3] w-full bg-slate-100 overflow-hidden">
        ...
        {/* Paid / Surplus Sale Price Badge (FREE is default rule) */}
        {isPaid && (
      ...
      <div className="p-3 space-y-2 flex-1 flex flex-col justify-between">
        <div className="space-y-1">
          {/* Metadata Subtitle: Provider & Distance */}
        ...
        <div className="pt-2 border-t border-slate-100 flex items-center justify-between gap-2">
          ...
          <button
            ...
            className={`font-extrabold text-xs py-1.5 px-3 rounded-xl transition flex-shrink-0 ${
